...
<tr>
	...
	<br>
	<a href="javascript:void(startURL('/neoHort/report_creator?$source=/neoHort/chart/table0.xml'));">
		<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
	</a>
	<a href="javascript:void(startURL('/neoHort/report_creator?$source=/neoHort/chart/table0.xml&$lib=html_xls'));">
		<img src="../images/xls_html.gif" border="0" alt="[xls/html]">
	</a>
	<a href="javascript:void(startURL('/neoHort/report_creator?$source=/neoHort/chart/table0.xml&$lib=xls'));">
		<img src="../images/xls.gif" border="0" alt="[Excel with tamplate]">
	</a>
	<a href="javascript:void(startURL('/neoHort/report_creator?$source=/neoHort/chart/table01.xml&$lib=xls'));">
...
<tr>
	...
	<br>
	<a href="javascript:void(startURL('/neoHort/report_creator?$source=/neoHort/chart/table1.xml'));">
		<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
	</a>
