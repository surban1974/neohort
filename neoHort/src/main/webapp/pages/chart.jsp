...
<tr>
	...
	<td width=250 align=center class="page_section">
		...
		<a href="javascript:void(startURL('/neoHort/chart/chart1.xml'));">
			<img src="../images/txt.gif" border="0" alt="[Source]">
		</a>
	</td>
</tr>
...
<tr>
	...
	<td width=250 align=center class="page_section">
		...
		<a href="javascript:void(startURL('/neoHort/chart/chart3.xml'));">
			<img src="../images/txt.gif" border="0" alt="[Source]">
		</a>
	</td>
</tr>
<tr>
	<td width=250 align=center class="page_section">
		...
		<a href="javascript:void(startURL('/neoHort/chart/chart4.xml'));">
			<img src="../images/txt.gif" border="0" alt="[Source]">
		</a>
	</td>
