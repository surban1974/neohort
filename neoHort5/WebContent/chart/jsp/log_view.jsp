...
<%
	if(request.getParameter("$source")!=null && request.getParameter("$lib")!=null && request.getParameter("$lib").equals("pdf")){
		response.setHeader("Content-Type","Application/pdf");
	}
	if(request.getParameter("$source")!=null && request.getParameter("$lib")!=null && request.getParameter("$lib").equals("xls")){
...
<IMAGE IMAGE_SOURCE="/neoHort5/images/logo_small.gif" ABSOLUTE_X="20" ABSOLUTE_Y="20"/>				
	</DOCUMENT>
</GENERAL>
