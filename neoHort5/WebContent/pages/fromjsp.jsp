...
You can create new report from SIMPLE JSP file (this file must generate xml-template as result of its elaboration). Example of use: http://localhost/neoHort5/log_view.jsp?<b>ReportProvider=neoHort</b>
...
&lt;/filter-mapping&gt;			
		...
		<br>
		<a href="javascript:void(showAsIFrame('/neoHort5/chart/jsp/log_view.jsp?ReportProvider=neoHort&$lib=pdf&$type=stream',900,500));">
			<img src="../images/pdf_jsp.gif" border="0" alt="[from JSP - Pdf version]">			
		</a>
		<a href="javascript:void(startURL('/neoHort5/chart/jsp/log_view.jsp?ReportProvider=neoHort&$lib=xls&$type=attachment'));">
			<img src="../images/xls_jsp.gif" border="0" alt="[from JSP - Excel version]">
		</a>
		<a href="javascript:void(startURL('/neoHort5//chart/jsp/log_view.jsp'));">
	...
	<td  class="page_section">
		...
		<br>
		<a href="javascript:void(showAsIFrame('/neoHort5/report_creator?$source=/chart/jsp/log_view.jsp&$lib=pdf&$type=stream',900,500));">
			<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
		</a>
		<a href="javascript:void(startURL('/neoHort5/report_creator?$source=/chart/jsp/log_view.jsp&$lib=xls&$type=attachment'));">
