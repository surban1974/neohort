...
<tr>
	...
	<br>
	<a href="javascript:void(showAsIFrame('/neoHort5/report_creator?$source=/neoHort5/chart/table0.xml&$type=stream',900,500));">
		<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
	</a>
	<a href="javascript:void(startURL('/neoHort5/report_creator?$source=/neoHort5/chart/table0.xml&$lib=html_xls&$type=attachment'));">
		<img src="../images/xls_html.gif" border="0" alt="[xls/html]">
	</a>
	<a href="javascript:void(startURL('/neoHort5/report_creator?$source=/neoHort5/chart/table0.xml&$lib=xls&$type=attachment'));">
		<img src="../images/xls.gif" border="0" alt="[Excel with tamplate]">
	</a>
	<a href="javascript:void(startURL('/neoHort5/report_creator?$source=/neoHort5/chart/table01.xml&$lib=xls&$type=attachment'));">
		<img src="../images/xls.gif" border="0" alt="[Excel without tamplate]">
	</a>
	<a href="javascript:void(startURL('/neoHort5/chart/table0.xml'));">
...
<tr>
	...
	<br>
	<a href="javascript:void(showAsIFrame('/neoHort5/report_creator?$source=/neoHort5/chart/table1.xml&$type=stream',900,500));">
		<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
	</a>
	<a href="javascript:void(startURL('/neoHort5/chart/table1.xml'));">
		<img src="../images/txt.gif" border="0" alt="[Source]">
	</a>
	</td>
</tr>
