...
&lt;/filter-mapping&gt;			
		...
		<br>
		<a href="javascript:void(showAsIFrame('../chart/jsp/log_view.jsp?ReportProvider=neoHort&$lib=pdf&$type=stream',900,500));">
			<img src="../images/pdf_jsp.gif" border="0" alt="[from JSP - Pdf version]">			
		</a>
		<a href="javascript:void(startURL('../chart/jsp/log_view.jsp?ReportProvider=neoHort&$lib=xlsx&$type=attachment'));">
			<img src="../images/xls_jsp.gif" border="0" alt="[from JSP - Excel version]">
		</a>
		<a href="javascript:void(startURL('..//chart/jsp/log_view.jsp'));">
	...
	<td  class="page_section">
		...
		<br>
		<a href="javascript:void(showAsIFrame('../report_creator?$source=/chart/jsp/log_view.jsp&$lib=pdf&$type=stream',900,500));">
			<img src="../images/pdf.gif" border="0" alt="[Pdf version]">
		</a>
		<a href="javascript:void(startURL('../report_creator?$source=/chart/jsp/log_view.jsp&$lib=xlsx&$type=attachment'));">
