...
<tr>
	...
	<a href="javascript:void(startURL('../report_creator?$source=/chart/table0.xml&$lib=xlsx&$type=attachment'));">
		<img src="../images/xls.gif" border="0" alt="[Excel with tamplate]">
	</a>
	<a href="javascript:void(startURL('../report_creator?$source=/chart/table01.xml&$lib=xlsx&$type=attachment'));">
