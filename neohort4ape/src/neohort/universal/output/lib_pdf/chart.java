...
public void executeLast(Hashtable _tagLibrary, Hashtable _beanLibrary){
	try{
			...
			com.itextpdf.text.Image chartIm = null;
			try{
...
private Rectangle placeBarcode(PdfContentByte cb) {
	try{
		...
		BaseColor font_label_color_top = getField_Color(getFONT_LABEL_COLOR_TOP(),BaseColor.BLACK);
	...
	BaseColor font_color_scale_X = new BaseColor(BaseColor.BLACK.getRGB());
	BaseColor font_color_scale_Y = new BaseColor(BaseColor.BLACK.getRGB());
		java.util.StringTokenizer st_font_color_scale = new java.util.StringTokenizer(getFONT_SCALE_COLOR_XYZ(), ";");
		if(st_font_color_scale.hasMoreTokens()) font_color_scale_X = getField_Color(st_font_color_scale.nextToken(),BaseColor.BLACK);
		if(st_font_color_scale.hasMoreTokens()) font_color_scale_Y = getField_Color(st_font_color_scale.nextToken(),BaseColor.BLACK);

	BaseColor font_color_label_X = new BaseColor(BaseColor.BLACK.getRGB());
	BaseColor font_color_label_Y = new BaseColor(BaseColor.BLACK.getRGB());
	...
	BaseColor element_color_2d_top = new BaseColor(BaseColor.BLACK.getRGB());
		java.util.StringTokenizer st_element_color_2d = new java.util.StringTokenizer(getELEMENT_COLOR_3D(), ";");
		if(st_element_color_2d.hasMoreTokens()) element_color_2d_bar = getField_Color(st_element_color_2d.nextToken(),BaseColor.BLUE);
		if(st_element_color_2d.hasMoreTokens()) element_color_2d_right = getField_Color(st_element_color_2d.nextToken(),BaseColor.LIGHT_GRAY);
		if(st_element_color_2d.hasMoreTokens()) element_color_2d_top = getField_Color(st_element_color_2d.nextToken(),BaseColor.BLACK);
