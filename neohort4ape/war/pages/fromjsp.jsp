...
You can create new report from SIMPLE JSP file (this file must generate xml-template as result of its elaboration). Example of use: http://localhost/log_view.jsp?<b>ReportProvider=neoHort</b>
...
&lt;/filter-mapping&gt;			
		...
		<a href="javascript:void(startURL('/chart/jsp/log_view.jsp?ReportProvider=neoHort&$lib=xls&$type=attachment'));">
	...
	<td  class="page_section">
		...
		<a href="javascript:void(startURL('/report_creator?$source=/chart/jsp/log_view.jsp&$lib=xls&$type=attachment'));">
