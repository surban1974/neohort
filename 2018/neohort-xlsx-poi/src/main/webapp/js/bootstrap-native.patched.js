...
(function(factory){
  ...
  Button.prototype = {
    ...
    actions : function() {
      var self;
// PATCH for compatibility with ie11
    	  try{
              self = this,
        	  ...
        	  var evt = document.createEvent('CustomEvent').initCustomEvent('bs.button.change', false, false, {});
        	  self = this,evt;    		  
    	  }
...
// PATCH for compatibility with ie11    	  
    	try{  
    		...
    		slid = document.createEvent('CustomEvent').initCustomEvent('slid.bs.carousel', false, false, {});
    	}
    	try{
    		slide = new CustomEvent("slide.bs.carousel");
    	}catch(e){
    		slide = document.createEvent('CustomEvent').initCustomEvent('slide.bs.carousel', false, false, {});
    	}
