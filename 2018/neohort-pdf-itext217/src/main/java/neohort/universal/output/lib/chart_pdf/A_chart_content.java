...
public abstract class A_chart_content implements I_chart_content, java.io.Serializable {
	...
	public Color element_color_1 = Color.blue;
...
public void _prepareline_dsh(PdfContentByte cb, float x0, float y0, float x1, float y1, float diap, Color color) {	
