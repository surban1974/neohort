      	...
      	<div class="panel panel-default" style="padding: 4px;">
  			<div class="panel-body"><h4>Download and install</h4>
		      	<ul class="nav nav-tabs" >
		  			...
		  			<li role="template01" >					<a href="#template01" id="template01-tab" role="template01" data-toggle="tab" aria-controls="template01" aria-expanded="true">Maven integration with OpenPdf</a></li>
		  			<li role="template02" >					<a href="#template02" id="template02-tab" role="template02" data-toggle="tab" aria-controls="template02" aria-expanded="true">Maven integration with iText 2.1.7</a></li>
		  			<li role="template03" >					<a href="#template03" id="template03-tab" role="template03" data-toggle="tab" aria-controls="template02" aria-expanded="true">Maven integration with iText 5.5.*(AGPL)</a></li>
		  		</ul>	
		  		<div id="networkTabContent" class="tab-content" >
					...
					<div role="template00" class="tab-pane fade active in" id="template00" aria-labelledby="template00-tab" >
						<ul>
				       		...
				       		<li>	
				       			<h4>In the case if you prefer to use the MPL version of OpenPdf/iText RTF 2.1.7:</h4>
				       			<ul>
				       				<li><h4><a href="https://github.com/LibrePDF/OpenPDF">OpenPdf 1.0.5</a></h4></li>
...
<dependencies>
	...
	<dependency>
		...
		<version>1.4.0</version>
					...
					<div role="template03" class="tab-pane fade in" id="template03" aria-labelledby="template03-tab" >
		      			<pre ><xmp><repositories>
	<repository>
		<id>neohort-mvn-repo</id> 
		<url>https://github.com/surban1974/neohort/raw/mvn-repo/</url>
