...
public chart_content_CURVEB_XY() {
	super();
	reimposta();
}
...
//                	float yc1 = 0;
                	...
                	for (int i = 0; i < datiX.size()-1; i++) {
	                	...
	                	if(i>0){
	                		...
	                		double gamma = Math.acos((x0-xM)/m)-beta;
...
//		                	cb.fill();
	                		...
	                		double gamma1 = Math.acos((xM1-x0)/m1)-beta;
...
//		                	cb.setColorStroke(new BaseColor(BaseColor.GRAY.getRGB()));
//		                	cb.moveTo(xp, yp);
//		                	cb.lineTo(xp1,yp1);
//		                	cb.stroke();
...
//	                	cb.setColorStroke(element_color_2);
//	                    cb.moveTo(xc0, yc0);
//	                    cb.curveTo(x0, y0, x0, y0, xc1, yc1);
//	                    cb.stroke();
