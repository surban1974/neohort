...
public void reimposta(){
	_LogPattern=			"neohort.log.log_patternSimple";
	_LogPath=				"iHort.logs/";
	_LogName=				"iHort";
...
public void init() {
	...
	_LogPattern = (_LogPattern==null)?((System.getProperty(id_LogPattern)==null)?"neohort.log.log_patternSimple":System.getProperty(id_LogPattern)):_LogPattern;
...
public void init(Properties ex_property) {
	...
	_LogPattern = (_LogPattern==null)?((ex_property.getProperty(id_LogPattern)==null)?"neohort.log.log_patternSimple":ex_property.getProperty(id_LogPattern)):_LogPattern;
	if(_LogPath==null || _LogPath.equals("")) return;
	if(_LogName==null || _LogName.equals("")){
		if(_LogMaskFormat==null || _LogMaskFormat.equals("")) _LogMaskFormat = "yyyyMMdd_hhmmssss";
		if(_LogMaskName==null) _LogMaskName = "application";
